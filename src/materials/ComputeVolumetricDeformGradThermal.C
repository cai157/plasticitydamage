...
//registerMooseObject("TensorMechanicsApp", ComputeVolumetricDeformGradThermal);

template <>
InputParameters
validParams<ComputeVolumetricDeformGradThermal>()
{
...
ComputeVolumetricDeformGradThermal::ComputeVolumetricDeformGradThermal(const InputParameters & parameters)
...
/*
void
ComputeVolumetricDeformGradThermal::initQpStatefulProperties()
{
...
/*
void
ComputeVolumetricDeformGradThermal::computeQpProperties()
{
...
/*
void
ComputeVolumetricDeformGradThermal::createVolumetricDeformGrad()
{
  _volumetric_deform_grad[_qp].zero();
  _volumetric_deform_grad[_qp].addIa(1.0);
}
