...
template <>
InputParameters
validParams<FiniteStrainCrystalPlasticityGG>()
{
...
FiniteStrainCrystalPlasticityGG::FiniteStrainCrystalPlasticityGG(const InputParameters & parameters)
  : ComputeStressBase(parameters),
    ...
    _slip_strain_out(declareProperty<std::vector<Real> >("slip_strain_out")),
    _slip_strain_out_old(declarePropertyOld<std::vector<Real> >("slip_strain_out")),
    ...
    _elasticity_tensor_old(getMaterialPropertyOld<RankFourTensor>("elasticity_tensor")),

    _crysrot(getMaterialProperty<RankTwoTensor>("crysrot")),
    _crysrot_old(getMaterialPropertyOld<RankTwoTensor>("crysrot")),
...
void
FiniteStrainCrystalPlasticityGG::initQpStatefulProperties()
{
  _stress[_qp].zero();
  ...
  _slip_strain_out[_qp].resize(_nss,0.0);
...
void
FiniteStrainCrystalPlasticityGG::initSlipSysProps()
{
...
void
FiniteStrainCrystalPlasticityGG::assignSlipSysRes()
{
...
void
FiniteStrainCrystalPlasticityGG::readFileInitSlipSysRes()
{
  _gss[_qp].resize(_nss);
...
void
FiniteStrainCrystalPlasticityGG::getInitSlipSysRes()
{
  if (_gprops.size() <= 0)
...
void
FiniteStrainCrystalPlasticityGG::readFileFlowRateParams()
{
  _a0.resize(_nss);
  _xm.resize(_nss);
...
void
FiniteStrainCrystalPlasticityGG::getFlowRateParams()
{
...
void
FiniteStrainCrystalPlasticityGG::readFileHardnessParams()
{
}

// Read hardness parameters from .i file
void
FiniteStrainCrystalPlasticityGG::getHardnessParams()
{
  if (_hprops.size() <= 0)
...
void
FiniteStrainCrystalPlasticityGG::getSlipSystems()
{
...
void
FiniteStrainCrystalPlasticityGG::initAdditionalProps()
{
}
 ...
 */
void
FiniteStrainCrystalPlasticityGG::computeQpStress()
{
...
void
FiniteStrainCrystalPlasticityGG::preSolveQp()
{
  // Initialize variable
  if (_first_substep)
  {
...
void
FiniteStrainCrystalPlasticityGG::solveQp()
{
  preSolveStatevar();
  solveStatevar();
  if (_err_tol)
...
void
FiniteStrainCrystalPlasticityGG::postSolveQp()
{
  if (_err_tol)
  {
    _err_tol = false;
  ...
  else
  {
    ...
    _elastic_strain[_qp] = _lag_e[_qp];
...
void
FiniteStrainCrystalPlasticityGG::preSolveStatevar()
{
...
void
FiniteStrainCrystalPlasticityGG::solveStatevar()
{
  Real gmax, gdiff;
  unsigned int iterg;
...
void
FiniteStrainCrystalPlasticityGG::postSolveStatevar()
{
  if (_max_substep_iter == 1) // No substepping
  {
    _gss[_qp] = _gss_tmp;
...
void
FiniteStrainCrystalPlasticityGG::preSolveStress()
{
  if (_max_substep_iter == 1) // No substepping
  {
...
void
FiniteStrainCrystalPlasticityGG::solveStress()
{
  unsigned int iter = 0;
...
void
FiniteStrainCrystalPlasticityGG::postSolveStress()
{
  if (_max_substep_iter == 1) // No substepping
  {
...
void
FiniteStrainCrystalPlasticityGG::update_slip_system_resistance()
{
  updateGss();
}
 ...
 */
void
FiniteStrainCrystalPlasticityGG::updateGss()
{
...
void
FiniteStrainCrystalPlasticityGG::calc_resid_jacob(RankTwoTensor & resid, RankFourTensor & jac)
{
  calcResidual(resid);
  if (_err_tol)
    return;
...
void
FiniteStrainCrystalPlasticityGG::calcResidual(RankTwoTensor & resid)
{
...
void
FiniteStrainCrystalPlasticityGG::calcJacobian(RankFourTensor & jac)
{
...
void
FiniteStrainCrystalPlasticityGG::getSlipIncrements()
{
  for (unsigned int i = 0; i < _nss; ++i)
  {
    _slip_incr(i) = _a0(i) * std::pow(std::abs(_tau(i) / _gss_tmp[i]), 1.0 / _xm(i)) *
                    copysign(1.0, _tau(i)) * _dt;
    _slip_strain(i) = _a0(i) * std::pow(std::abs(_tau(i) / _gss_tmp[i]), 1.0 / _xm(i)) * copysign(1.0, _tau(i));
    _slip_strain_out[_qp][i] = _slip_strain(i) + _slip_strain_out_old[_qp][i];
...
RankTwoTensor
FiniteStrainCrystalPlasticityGG::get_current_rotation(const RankTwoTensor & a)
{
  return getMatRot(a);
}
...
RankTwoTensor
FiniteStrainCrystalPlasticityGG::getMatRot(const RankTwoTensor & a)
{
  RankTwoTensor rot;
...
void
FiniteStrainCrystalPlasticityGG::computeQpElasticityTensor()
{
}

RankFourTensor
FiniteStrainCrystalPlasticityGG::calcTangentModuli()
{
...
void
FiniteStrainCrystalPlasticityGG::calc_schmid_tensor()
{
...
RankFourTensor
FiniteStrainCrystalPlasticityGG::elastoPlasticTangentModuli()
{
  RankFourTensor tan_mod;
...
RankFourTensor
FiniteStrainCrystalPlasticityGG::elasticTangentModuli()
{
  return _elasticity_tensor[_qp]; // update jacobian_mult
}

bool
FiniteStrainCrystalPlasticityGG::line_search_update(const Real rnorm_prev, const RankTwoTensor dpk2)
{
...
void
FiniteStrainCrystalPlasticityGG::internalVariableUpdateNRiteration()
{
