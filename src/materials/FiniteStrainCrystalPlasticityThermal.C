...
template <>
InputParameters
validParams<FiniteStrainCrystalPlasticityThermal>()
{
...
FiniteStrainCrystalPlasticityThermal::FiniteStrainCrystalPlasticityThermal(const InputParameters & parameters)
  : ComputeStressBase(parameters),
    ...
    _thermal_deform_grad(getMaterialProperty<RankTwoTensor>("thermal_deform_grad")),
...
void
FiniteStrainCrystalPlasticityThermal::initQpStatefulProperties()
{
  _stress[_qp].zero();
...
void
FiniteStrainCrystalPlasticityThermal::initSlipSysProps()
{
...
void
FiniteStrainCrystalPlasticityThermal::assignSlipSysRes()
{
...
void
FiniteStrainCrystalPlasticityThermal::readFileInitSlipSysRes()
{
  _gss[_qp].resize(_nss);
...
void
FiniteStrainCrystalPlasticityThermal::getInitSlipSysRes()
{
  if (_gprops.size() <= 0)
...
void
FiniteStrainCrystalPlasticityThermal::readFileFlowRateParams()
{
  _a0.resize(_nss);
  _xm.resize(_nss);
...
void
FiniteStrainCrystalPlasticityThermal::getFlowRateParams()
{
...
void
FiniteStrainCrystalPlasticityThermal::readFileHardnessParams()
{
}

// Read hardness parameters from .i file
void
FiniteStrainCrystalPlasticityThermal::getHardnessParams()
{
  if (_hprops.size() <= 0)
...
void
FiniteStrainCrystalPlasticityThermal::getSlipSystems()
{
...
void
FiniteStrainCrystalPlasticityThermal::initAdditionalProps()
{
}
 ...
 */
void
FiniteStrainCrystalPlasticityThermal::computeQpStress()
{
  ...
  RankTwoTensor modified_deformation_gradient_old;
  modified_deformation_gradient_old = _deformation_gradient_old[_qp] * _thermal_deform_grad[_qp];
  RankTwoTensor modified_deformation_gradient;
  modified_deformation_gradient = _deformation_gradient[_qp] * _thermal_deform_grad[_qp];
    
  if (_max_substep_iter > 1)
  {
    _dfgrd_tmp_old = modified_deformation_gradient_old;
    if (_dfgrd_tmp_old.det() == 0)
      _dfgrd_tmp_old.addIa(1.0);

    _delta_dfgrd = modified_deformation_gradient - _dfgrd_tmp_old;
...
void
FiniteStrainCrystalPlasticityThermal::preSolveQp()
{
    RankTwoTensor modified_deformation_gradient;
    modified_deformation_gradient = _deformation_gradient[_qp] *_thermal_deform_grad[_qp];
  ...
  if (_max_substep_iter == 1)
    _dfgrd_tmp = modified_deformation_gradient; // Without substepping
  else
...
void
FiniteStrainCrystalPlasticityThermal::solveQp()
{
  preSolveStatevar();
  solveStatevar();
  if (_err_tol)
...
void
FiniteStrainCrystalPlasticityThermal::postSolveQp()
{
    RankTwoTensor modified_deformation_gradient;
    modified_deformation_gradient = _deformation_gradient[_qp] *_thermal_deform_grad[_qp];
  
    std::cout << "ft00:" << _thermal_deform_grad[_qp](0,0) << '\n';
    std::cout << "ft11:" << _thermal_deform_grad[_qp](1,1) << '\n';
    std::cout << "ft22:" << _thermal_deform_grad[_qp](2,2) << '\n';
    std::cout << "ft10:" << _thermal_deform_grad[_qp](1,0) << '\n';
    std::cout << "ft12:" << _thermal_deform_grad[_qp](1,2) << '\n';
    std::cout << "ft20:" << _thermal_deform_grad[_qp](2,0) << '\n';

    std::cout << "f00:" << _deformation_gradient[_qp](0,0) << '\n';
    std::cout << "f11:" << _deformation_gradient[_qp](1,1) << '\n';
    std::cout << "f22:" << _deformation_gradient[_qp](2,2) << '\n';
    std::cout << "f10:" << _deformation_gradient[_qp](1,0) << '\n';
    std::cout << "f12:" << _deformation_gradient[_qp](1,2) << '\n';
    std::cout << "f20:" << _deformation_gradient[_qp](2,0) << '\n';
  ...
  else
  {
    ...
    _lag_e[_qp] = modified_deformation_gradient.transpose() * modified_deformation_gradient - iden;
    _lag_e[_qp] = _lag_e[_qp] * 0.5;

    RankTwoTensor rot;
    rot = get_current_rotation(modified_deformation_gradient); // Calculate material rotation
    _update_rot[_qp] = rot * _crysrot[_qp];
  }
}

void
FiniteStrainCrystalPlasticityThermal::preSolveStatevar()
{
...
void
FiniteStrainCrystalPlasticityThermal::solveStatevar()
{
  Real gmax, gdiff;
  unsigned int iterg;
...
void
FiniteStrainCrystalPlasticityThermal::postSolveStatevar()
{
  if (_max_substep_iter == 1) // No substepping
  {
    _gss[_qp] = _gss_tmp;
...
void
FiniteStrainCrystalPlasticityThermal::preSolveStress()
{
  if (_max_substep_iter == 1) // No substepping
  {
...
void
FiniteStrainCrystalPlasticityThermal::solveStress()
{
  unsigned int iter = 0;
...
void
FiniteStrainCrystalPlasticityThermal::postSolveStress()
{
  if (_max_substep_iter == 1) // No substepping
  {
...
void
FiniteStrainCrystalPlasticityThermal::update_slip_system_resistance()
{
  updateGss();
}
 ...
 */
void
FiniteStrainCrystalPlasticityThermal::updateGss()
{
...
void
FiniteStrainCrystalPlasticityThermal::calc_resid_jacob(RankTwoTensor & resid, RankFourTensor & jac)
{
  calcResidual(resid);
  if (_err_tol)
    return;
...
void
FiniteStrainCrystalPlasticityThermal::calcJacobian(RankFourTensor & jac)
{
...
RankTwoTensor
FiniteStrainCrystalPlasticityThermal::get_current_rotation(const RankTwoTensor & a)
{
  return getMatRot(a);
}
...
RankTwoTensor
FiniteStrainCrystalPlasticityThermal::getMatRot(const RankTwoTensor & a)
{
  RankTwoTensor rot;
...
void
FiniteStrainCrystalPlasticityThermal::computeQpElasticityTensor()
{
}

RankFourTensor
FiniteStrainCrystalPlasticityThermal::calcTangentModuli()
{
...
void
FiniteStrainCrystalPlasticityThermal::calc_schmid_tensor()
{
...
RankFourTensor
FiniteStrainCrystalPlasticityThermal::elastoPlasticTangentModuli()
{
  RankFourTensor tan_mod;
...
RankFourTensor
FiniteStrainCrystalPlasticityThermal::elasticTangentModuli()
{
  return _elasticity_tensor[_qp]; // update jacobian_mult
}

bool
FiniteStrainCrystalPlasticityThermal::line_search_update(const Real rnorm_prev, const RankTwoTensor dpk2)
{
...
void
FiniteStrainCrystalPlasticityThermal::internalVariableUpdateNRiteration()
{
