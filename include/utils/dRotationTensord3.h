...
#ifndef DROTATIONTENSORD3_H
#define DROTATIONTENSORD3_H
 ...
 */
class dRotationTensord3 : public RealTensorValue
{
public:
  ...
  dRotationTensord3(Axis axis, Real angle);

  /// fills according to Euler angles (measured in degrees)
  dRotationTensord3(const RealVectorValue & euler_angles);

  /// reforms the rotation matrix according to axis and angle.
  void update3(Axis axis, Real angle);

  /// reforms the rotation matrix according to the Euler angles.
  void update3(const RealVectorValue & euler_angles);
};

#endif // DROTATIONTENSORD3_H
