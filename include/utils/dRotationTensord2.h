...
#ifndef DROTATIONTENSORD2_H
#define DROTATIONTENSORD2_H
 ...
 */
class dRotationTensord2 : public RealTensorValue
{
public:
  ...
  dRotationTensord2(Axis axis, Real angle);

  /// fills according to Euler angles (measured in degrees)
  dRotationTensord2(const RealVectorValue & euler_angles);

  /// reforms the rotation matrix according to axis and angle.
  void update2(Axis axis, Real angle);

  /// reforms the rotation matrix according to the Euler angles.
  void update2(const RealVectorValue & euler_angles);
};

#endif // DROTATIONTENSORD2_H
