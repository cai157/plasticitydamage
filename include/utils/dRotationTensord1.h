...
#ifndef DROTATIONTENSORD1_H
#define DROTATIONTENSORD1_H
 ...
 */
class dRotationTensord1 : public RealTensorValue
{
public:
  ...
  dRotationTensord1(Axis axis, Real angle);

  /// fills according to Euler angles (measured in degrees)
  dRotationTensord1(const RealVectorValue & euler_angles);

  /// reforms the rotation matrix according to axis and angle.
  void update1(Axis axis, Real angle);

  /// reforms the rotation matrix according to the Euler angles.
  void update1(const RealVectorValue & euler_angles);
};

#endif // DROTATIONTENSORD1_H
